...
public final class AEConfig extends Configuration implements IConfigurableObject, IConfigManagerHost {
    ...
    public int getSmallCableCapacity() {
        return this.smallCableCap;
    }

    public int getDenseCableCapacity() {
        return this.denseCableCap;
    }
    public int getX64CableCapacity() {
        return this.x64CableCap;
    }
    public int getX128CableCapacity() {
        return this.x128CableCap;
    }
