...
public final class ApiItems implements IItems {
    ...
    private final IItemDefinition cell1mb;
    private final IItemDefinition cell4mb;
    private final IItemDefinition cell16mb;
    private final IItemDefinition cell64mb;
    private final IItemDefinition cell256mb;
    ...
    public ApiItems(FeatureFactory registry) {
        ...
        this.cell1mb = storageCells.item("storage_cell_1mb", () -> new BasicItemStorageCell(MaterialType.CELL1MB_PART, 1024)).build();
        this.cell4mb = storageCells.item("storage_cell_4mb", () -> new BasicItemStorageCell(MaterialType.CELL4MB_PART, 4096)).build();
        this.cell16mb = storageCells.item("storage_cell_16mb", () -> new BasicItemStorageCell(MaterialType.CELL16MB_PART, 16384)).build();
        this.cell64mb = storageCells.item("storage_cell_64mb", () -> new BasicItemStorageCell(MaterialType.CELL64MB_PART, 65536)).build();
        this.cell256mb = storageCells.item("storage_cell_256mb", () -> new BasicItemStorageCell(MaterialType.CELL256MB_PART, 262144)).build();
    ...
    @Override
    public IItemDefinition cell1mb() {
        return this.cell1mb;
    }
    @Override
    public IItemDefinition cell4mb() {
        return this.cell4mb;
    }
    @Override
    public IItemDefinition cell16mb() {
        return this.cell16mb;
    }
    @Override
    public IItemDefinition cell64mb() {
        return this.cell64mb;
    }
    @Override
    public IItemDefinition cell256mb() {
        return this.cell256mb;
    }
    @Override
