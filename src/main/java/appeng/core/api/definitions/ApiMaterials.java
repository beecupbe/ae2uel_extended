...
public final class ApiMaterials implements IMaterials {
    ...
    private final IItemDefinition cell1mbPart;
    private final IItemDefinition cell4mbPart;
    private final IItemDefinition cell16mbPart;
    private final IItemDefinition cell64mbPart;
    private final IItemDefinition cell256mbPart;
    private final IItemDefinition cell1gbPart;
    private final IItemDefinition cell2gbPart;
    ...
    private final IItemDefinition fluidCell64mbPart;
    private final IItemDefinition fluidCell256mbPart;
    ...
    public ApiMaterials(FeatureFactory registry) {
        ...
        this.cell1mbPart = new DamagedItemDefinition("material.cell.storage.1mb", materials.createMaterial(MaterialType.CELL1MB_PART));
        this.cell4mbPart = new DamagedItemDefinition("material.cell.storage.4mb", materials.createMaterial(MaterialType.CELL4MB_PART));
        this.cell16mbPart = new DamagedItemDefinition("material.cell.storage.16mb", materials.createMaterial(MaterialType.CELL16MB_PART));
        this.cell64mbPart = new DamagedItemDefinition("material.cell.storage.64mb", materials.createMaterial(MaterialType.CELL64MB_PART));
        this.cell256mbPart = new DamagedItemDefinition("material.cell.storage.256mb", materials.createMaterial(MaterialType.CELL256MB_PART));
        this.cell1gbPart = new DamagedItemDefinition("material.cell.storage.1gb", materials.createMaterial(MaterialType.CELL1GB_PART));
        this.cell2gbPart = new DamagedItemDefinition("material.cell.storage.2gb", materials.createMaterial(MaterialType.CELL2GB_PART));
        ...
        this.fluidCell64mbPart = new DamagedItemDefinition("material.cell.storage.64mb", materials.createMaterial(MaterialType.FLUID_CELL64MB_PART));
        this.fluidCell256mbPart = new DamagedItemDefinition("material.cell.storage.256mb", materials.createMaterial(MaterialType.FLUID_CELL256MB_PART));
    }
    ...
    @Override
    public IItemDefinition cell1mbPart() {
        return this.cell1mbPart;
    }
    @Override
    public IItemDefinition cell4mbPart() {
        return this.cell4mbPart;
    }
    @Override
    public IItemDefinition cell16mbPart() {
        return this.cell16mbPart;
    }
    @Override
    public IItemDefinition cell64mbPart() {
        return this.cell64mbPart;
    }
    @Override
    public IItemDefinition cell256mbPart() {
        return this.cell256mbPart;
    }
    @Override
    public IItemDefinition cell1gbPart() {
        return this.cell1gbPart;
    }
    @Override
    public IItemDefinition cell2gbPart() {
        return this.cell2gbPart;
    }
    ...
    public IItemDefinition fluidCell64mbPart() {
        return this.fluidCell64mbPart;
    }

    public IItemDefinition fluidCell256mbPart() {
        return this.fluidCell256mbPart;
    }
}
