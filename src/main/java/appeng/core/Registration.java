...
final class Registration {
    ...
    void postInit(final FMLPostInitializationEvent event) {
        ...
        Upgrades.FUZZY.registerItem(items.cell1mb(), 1);
        Upgrades.INVERTER.registerItem(items.cell1mb(), 1);

        Upgrades.FUZZY.registerItem(items.cell4mb(), 1);
        Upgrades.INVERTER.registerItem(items.cell4mb(), 1);

        Upgrades.FUZZY.registerItem(items.cell16mb(), 1);
        Upgrades.INVERTER.registerItem(items.cell16mb(), 1);

        Upgrades.FUZZY.registerItem(items.cell64mb(), 1);
        Upgrades.INVERTER.registerItem(items.cell64mb(), 1);

        Upgrades.FUZZY.registerItem(items.cell256mb(), 1);
        Upgrades.INVERTER.registerItem(items.cell256mb(), 1);
