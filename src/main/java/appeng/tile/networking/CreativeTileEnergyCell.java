...
public class CreativeTileEnergyCell extends AENetworkTile implements IAEPowerStorage {

    private double internalCurrentPower = Long.MAX_VALUE / 10000;
    private long internalMaxPower = Long.MAX_VALUE / 10000;
    ...
    void setInternalMaxPower(final long internalMaxPower) {
