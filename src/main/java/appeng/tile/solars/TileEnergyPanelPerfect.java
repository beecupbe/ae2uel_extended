...
public class TileEnergyPanelPerfect extends AENetworkTile implements IGridTickable {
    public static double powerPerTick = AEConfig.instance().getPerfectSolarPanelGenPerTick();
    public static final double powerPerTickAtNight = AEConfig.instance().getPerfectSolarPanelGenPerTickNight();
    public static final double internalMaxEnergyCapacity = AEConfig.instance().getPerfectSolarPanelCapacity();
