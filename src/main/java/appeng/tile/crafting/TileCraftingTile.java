...
public class TileCraftingTile extends AENetworkTile implements IAEMultiBlock, IPowerChannelState {
    ...
    protected ItemStack getItemFromTile(final Object obj) {
        ...
        } else if (((TileCraftingTile) obj).isAcceleratorx4()) {
            is = AEApi.instance().definitions().blocks().craftingAcceleratorx4().maybeStack(1);
        } else if (((TileCraftingTile) obj).isAcceleratorx16()) {
    ...
    public boolean isAcceleratorx4() {
        ...
        final BlockCraftingUnit unit = (BlockCraftingUnit) this.world.getBlockState(this.pos).getBlock();
        return unit.type == CraftingUnitType.ACCELERATOR_4X;
    }
    ...
    public boolean isAcceleratorx16() {
        ...
        final BlockCraftingUnit unit = (BlockCraftingUnit) this.world.getBlockState(this.pos).getBlock();
        return unit.type == CraftingUnitType.ACCELERATOR_16X;
    }
