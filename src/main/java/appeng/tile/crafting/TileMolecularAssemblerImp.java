...
public class TileMolecularAssemblerImp extends AENetworkInvTile implements IUpgradeableHost, IConfigManagerHost, IGridTickable, ICraftingMachine, IPowerChannelState {
    ...
    private class CraftingGridFilter implements IAEItemFilter {
        private boolean hasPattern() {
            return TileMolecularAssemblerImp.this.myPlan != null && !ItemHandlerUtil.isEmpty(TileMolecularAssemblerImp.this.patternInv);
        }
        ...
        public boolean allowInsert(IItemHandler inv, int slot, ItemStack stack) {
            ...
            if (this.hasPattern()) {
                return TileMolecularAssemblerImp.this.myPlan.isValidItemForSlot(slot, stack, TileMolecularAssemblerImp.this.getWorld());
            }
            return false;
        }
    }
