...
public class TileMolecularAssemblerCreative extends AENetworkInvTile implements IUpgradeableHost, IConfigManagerHost, IGridTickable, ICraftingMachine, IPowerChannelState {
    ...
    public TickRateModulation tickingRequest(final IGridNode node, int ticksSinceLastCall) {
        ...
        if (this.myPlan == null || !this.isAwake) {
            this.updateSleepiness();
    ...
    private class CraftingGridFilter implements IAEItemFilter {
        private boolean hasPattern() {
            return TileMolecularAssemblerCreative.this.myPlan != null && !ItemHandlerUtil.isEmpty(TileMolecularAssemblerCreative.this.patternInv);
        }
        ...
        public boolean allowInsert(IItemHandler inv, int slot, ItemStack stack) {
            ...
            if (this.hasPattern()) {
                return TileMolecularAssemblerCreative.this.myPlan.isValidItemForSlot(slot, stack, TileMolecularAssemblerCreative.this.getWorld());
            }
            return false;
        }
    }
