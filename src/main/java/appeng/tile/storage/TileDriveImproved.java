...
import appeng.me.storage.DriveWatcherImproved;
...
public class TileDriveImproved extends AENetworkInvTile implements IChestOrDrive, IPriorityHost {
    ...
    public ItemStack getItemStackRepresentation() {
        return AEApi.instance().definitions().blocks().driveImp().maybeStack(1).orElse(ItemStack.EMPTY);
    }

    @Override
    public GuiBridge getGuiBridge() {
        return GuiBridge.GUI_DRIVE_IMPROVED;
    }
}
