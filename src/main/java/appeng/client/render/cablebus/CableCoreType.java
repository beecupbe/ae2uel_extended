...
public enum CableCoreType {
    ...
    private static Map<AECableType, CableCoreType> generateCableMapping() {
        ...
        result.put(AECableType.CABLE_X64, CableCoreType.COVERED);
        result.put(AECableType.CABLE_X128, CableCoreType.COVERED);
        result.put(AECableType.CABLE_X256, CableCoreType.COVERED);
