        ...
        if (noAttachments && isStraightLine(cableType, connectionTypes)) {
            ...
            switch (cableType) {
                ...
                case COVERED:
                    ...
                    break;
                case CABLE_X64:
                    this.cableBuilder.addStraightCoveredX64Connection(facing, cableColor, quadsOut);
                    break;
                case CABLE_X128:
                    this.cableBuilder.addStraightCoveredX128Connection(facing, cableColor, quadsOut);
                    break;
                case CABLE_X256:
                    this.cableBuilder.addStraightCoveredX256Connection(facing, cableColor, quadsOut);
                    break;
               case SMART:
        ...
        for (EnumFacing facing : attachmentConnections.keySet()) {
            ...
            switch (cableType) {
                ...
                case COVERED:
                    ...
                    break;
                case CABLE_X64:
                    this.cableBuilder.addConstrainedCoveredX64Connection(facing, cableColor, distance, quadsOut);
                    break;
                case CABLE_X128:
                    this.cableBuilder.addConstrainedCoveredX128Connection(facing, cableColor, distance, quadsOut);
                    break;
                case CABLE_X256:
                    this.cableBuilder.addConstrainedCoveredX256Connection(facing, cableColor, distance, quadsOut);
                    break;
                case SMART:
        ...
        for (final Entry<EnumFacing, AECableType> connection : connectionTypes.entrySet()) {
            ...
            switch (cableType) {
                ...
                case COVERED:
                    ...
                    break;
                case CABLE_X64:
                    this.cableBuilder.addCoveredX64Connection(facing, cableColor, connectionType, cableBusAdjacent, quadsOut);
                    break;
                case CABLE_X128:
                    this.cableBuilder.addCoveredX128Connection(facing, cableColor, connectionType, cableBusAdjacent, quadsOut);
                    break;
                case CABLE_X256:
                    this.cableBuilder.addCoveredX256Connection(facing, cableColor, connectionType, cableBusAdjacent, quadsOut);
                    break;
                case SMART:
