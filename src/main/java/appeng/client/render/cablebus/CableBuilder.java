...
class CableBuilder {
    ...
    public void addCoveredX64Connection(EnumFacing facing, AEColor cableColor, AECableType connectionType, boolean cableBusAdjacent, List<BakedQuad> quadsOut) {
        ...
        TextureAtlasSprite texture = this.connectionTextures.get(AECableType.CABLE_X64).get(cableColor);
        cubeBuilder.setTexture(texture);
    ...
    public void addCoveredX128Connection(EnumFacing facing, AEColor cableColor, AECableType connectionType, boolean cableBusAdjacent, List<BakedQuad> quadsOut) {
        ...
        TextureAtlasSprite texture = this.connectionTextures.get(AECableType.CABLE_X128).get(cableColor);
        cubeBuilder.setTexture(texture);
    ...
    public void addCoveredX256Connection(EnumFacing facing, AEColor cableColor, AECableType connectionType, boolean cableBusAdjacent, List<BakedQuad> quadsOut) {
        ...
        TextureAtlasSprite texture = this.connectionTextures.get(AECableType.CABLE_X256).get(cableColor);
        cubeBuilder.setTexture(texture);
    ...
    public void addStraightCoveredX64Connection(EnumFacing facing, AEColor cableColor, List<BakedQuad> quadsOut) {
        CubeBuilder cubeBuilder = new CubeBuilder(this.format, quadsOut);
    ...
    public void addStraightCoveredX128Connection(EnumFacing facing, AEColor cableColor, List<BakedQuad> quadsOut) {
        CubeBuilder cubeBuilder = new CubeBuilder(this.format, quadsOut);
    ...
    public void addStraightCoveredX256Connection(EnumFacing facing, AEColor cableColor, List<BakedQuad> quadsOut) {
        CubeBuilder cubeBuilder = new CubeBuilder(this.format, quadsOut);
    ...
    public void addConstrainedCoveredX64Connection(EnumFacing facing, AEColor cableColor, int distanceFromEdge, List<BakedQuad> quadsOut) {
        // The core of a covered cable reaches up to 5 voxels from the block edge, so
        // drawing a connection can only occur from there onwards
        if (distanceFromEdge >= 5) {
            return;
    ...
    public void addConstrainedCoveredX128Connection(EnumFacing facing, AEColor cableColor, int distanceFromEdge, List<BakedQuad> quadsOut) {
        // The core of a covered cable reaches up to 5 voxels from the block edge, so
        // drawing a connection can only occur from there onwards
        if (distanceFromEdge >= 5) {
            return;
    ...
    public void addConstrainedCoveredX256Connection(EnumFacing facing, AEColor cableColor, int distanceFromEdge, List<BakedQuad> quadsOut) {
        // The core of a covered cable reaches up to 5 voxels from the block edge, so
        // drawing a connection can only occur from there onwards
        if (distanceFromEdge >= 5) {
            return;
    ...
    public void addSmartConnection(EnumFacing facing, AEColor cableColor, AECableType connectionType, boolean cableBusAdjacent, int channels, List<BakedQuad> quadsOut) {
        ...
        TextureAtlasSprite oddChannel = this.smartCableTextures.getOddTextureForChannels((int) (channels / (AEConfig.instance().getSmallCableCapacity() / 8)));
        TextureAtlasSprite evenChannel = this.smartCableTextures.getEvenTextureForChannels((int) (channels / (AEConfig.instance().getSmallCableCapacity() / 8)));
    ...
    public void addDenseSmartConnection(EnumFacing facing, AEColor cableColor, AECableType connectionType, boolean cableBusAdjacent, int channels, List<BakedQuad> quadsOut) {
        ...
        channels = (int) ((channels + 3) / 4) / (AEConfig.instance().getDenseCableCapacity() / 32);
