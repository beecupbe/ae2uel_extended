...
import appeng.container.implementations.ContainerUpgradeableImp;
...
public class GuiUpgradeableImp extends AEBaseGui implements IJEIGhostIngredients {
    private final Map<Target<?>, Object> mapTargetSlot = new HashMap<>();
    protected final ContainerUpgradeableImp cvb;
    ...
    public GuiUpgradeableImp(final InventoryPlayer inventoryPlayer, final IUpgradeableHost te) {
        this(new ContainerUpgradeableImp(inventoryPlayer, te));
    }

    public GuiUpgradeableImp(final ContainerUpgradeableImp te) {
        super(te);
        this.cvb = te;
    ...
    protected void handleButtonVisibility() {
            ...
            this.craftMode.setVisibility(true);
    ...
    protected GuiText getName() {
        return this.bc instanceof PartImportBusImp ? GuiText.ImportImp : this.bc instanceof PartExportBusImp ? GuiText.ExportImp : this.bc instanceof PartFluidImportBusImp ? GuiText.ImportImpFluids : this.bc instanceof PartFluidExportBusImp ? GuiText.ExportImpFluids : null;
    }
