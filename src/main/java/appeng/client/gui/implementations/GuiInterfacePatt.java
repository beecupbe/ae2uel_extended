...
public class GuiInterfacePatt extends GuiUpgradeable {

    private GuiTabButton priority;
    private GuiToggleButton interfaceMode;

    public GuiInterfacePatt(final InventoryPlayer inventoryPlayer, final IInterfaceHost te) {
        super(new ContainerInterfacePatt(inventoryPlayer, te));
        this.ySize = 256;
    }
    ...
    public void drawFG(final int offsetX, final int offsetY, final int mouseX, final int mouseY) {
        ...
        if (this.interfaceMode != null) {
            this.interfaceMode.setState(((ContainerInterfacePatt) this.cvb).getInterfaceTerminalMode() == YesNo.YES);
        }

        this.fontRenderer.drawString(this.getGuiDisplayName(GuiText.InterfacePatt.getLocal()), 8, 6, 4210752);
    }
