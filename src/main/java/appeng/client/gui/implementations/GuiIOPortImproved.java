...
import appeng.container.implementations.ContainerIOPortImproved;
...
public class GuiIOPortImproved extends GuiUpgradeable {

    private GuiImgButton fullMode;
    private GuiImgButton operationMode;

    public GuiIOPortImproved(final InventoryPlayer inventoryPlayer, final TileIOPortImp te) {
    ...
    public void drawFG(final int offsetX, final int offsetY, final int mouseX, final int mouseY) {
        this.fontRenderer.drawString(this.getGuiDisplayName(GuiText.IOPort.getLocal()), 67, 6, 4210752);
        this.fontRenderer.drawString(GuiText.inventory.getLocal(), 67, this.ySize - 96 + 3, 4210752);
