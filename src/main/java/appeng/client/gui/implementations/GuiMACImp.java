...
public class GuiMACImp extends GuiUpgradeable {

    private final ContainerMACImp container;
    private GuiProgressBar pb;

    public GuiMACImp(final InventoryPlayer inventoryPlayer, final TileMolecularAssemblerImp te) {
        super(new ContainerMACImp(inventoryPlayer, te));
        this.ySize = 197;
        this.container = (ContainerMACImp) this.inventorySlots;
    }
