...
public class DualityInterfaceImp implements IGridTickable, IStorageMonitorable, IInventoryDestination, IAEAppEngInventory, IConfigManagerHost, ICraftingProvider, IUpgradeableHost {
    public static final int NUMBER_OF_STORAGE_SLOTS = 18;
    ...
    private final IAEItemStack[] requireWork = {null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null};
    ...
    public DualityInterfaceImp(final AENetworkProxy networkProxy, final IInterfaceHost ih) {
            ...
            try {
                ...
                if (!targetTE.getInterfaceDualityImp().sameGrid(this.gridProxy.getGrid())) {
                    ...
                    if (mon != null) {
                        ...
                        if (sm != null && Platform.canAccess(targetTE.getInterfaceDualityImp().gridProxy, this.mySource)) {
    ...
    public IStorageMonitorable getMonitorable(final IActionSource src, final IStorageMonitorable myInterface) {
        ...
        final DualityInterfaceImp di = this;
    ...
    private class InterfaceRequestContext implements Comparable<Integer> {
        ...
        public int compareTo(Integer o) {
            return Integer.compare(DualityInterfaceImp.this.priority, o);
        }
    }
    ...
    private class InterfaceInventory extends MEMonitorIInventory {
        ...
        public InterfaceInventory(final DualityInterfaceImp tileInterface) {
        ...
        public IAEItemStack extractItems(final IAEItemStack request, final Actionable type, final IActionSource src) {
            final Optional<InterfaceRequestContext> context = src.context(InterfaceRequestContext.class);
            final boolean hasLowerOrEqualPriority = context.map(c -> c.compareTo(DualityInterfaceImp.this.priority) <= 0).orElse(false);
    ...
    private class Accessor implements IStorageMonitorableAccessor {
        ...
        public IStorageMonitorable getInventory(IActionSource src) {
            return DualityInterfaceImp.this.getMonitorable(src, DualityInterfaceImp.this);
        }
