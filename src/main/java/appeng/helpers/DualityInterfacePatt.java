...
public class DualityInterfacePatt implements IGridTickable, IStorageMonitorable, IInventoryDestination, IAEAppEngInventory, IConfigManagerHost, ICraftingProvider, IUpgradeableHost {
    ...
    public DualityInterfacePatt(final AENetworkProxy networkProxy, final IInterfaceHost ih) {
    ...
    public IStorageMonitorable getMonitorable(final IActionSource src, final IStorageMonitorable myInterface) {
        ...
        final DualityInterfacePatt di = this;
    ...
    private class InterfaceRequestContext implements Comparable<Integer> {
        ...
        public int compareTo(Integer o) {
            return Integer.compare(DualityInterfacePatt.this.priority, o);
        }
    }
    ...
    private class InterfaceInventory extends MEMonitorIInventory {
        ...
        public InterfaceInventory(final DualityInterfacePatt tileInterface) {
        ...
        public IAEItemStack extractItems(final IAEItemStack request, final Actionable type, final IActionSource src) {
            final Optional<InterfaceRequestContext> context = src.context(InterfaceRequestContext.class);
            final boolean hasLowerOrEqualPriority = context.map(c -> c.compareTo(DualityInterfacePatt.this.priority) <= 0).orElse(false);
    ...
    private class Accessor implements IStorageMonitorableAccessor {
        ...
        public IStorageMonitorable getInventory(IActionSource src) {
            return DualityInterfacePatt.this.getMonitorable(src, DualityInterfacePatt.this);
        }
