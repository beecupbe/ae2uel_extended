...
public class DualityInterfaceAdv implements IGridTickable, IStorageMonitorable, IInventoryDestination, IAEAppEngInventory, IConfigManagerHost, ICraftingProvider, IUpgradeableHost {
    public static final int NUMBER_OF_STORAGE_SLOTS = 27;

    public static final int NUMBER_OF_CONFIG_SLOTS = 27;

    public static final int NUMBER_OF_PATTERN_SLOTS = 18;

    private static final Collection<Block> BAD_BLOCKS = new HashSet<>(100);
    private final IAEItemStack[] requireWork = {null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null};
    ...
    public DualityInterfaceAdv(final AENetworkProxy networkProxy, final IInterfaceHost ih) {
    ...
    private void pushItemsOut(final EnumFacing s) {
        ...
        if (te instanceof IInterfaceHost || (te instanceof TileCableBus && ((TileCableBus) te).getPart(s.getOpposite()) instanceof PartInterface)) {
            try {
                ...
                if (!targetTE.getInterfaceDualityAdv().sameGrid(this.gridProxy.getGrid())) {
                    ...
                    if (mon != null) {
                        ...
                        if (sm != null && Platform.canAccess(targetTE.getInterfaceDualityAdv().gridProxy, this.mySource)) {
    ...
    public IStorageMonitorable getMonitorable(final IActionSource src, final IStorageMonitorable myInterface) {
        ...
        final DualityInterfaceAdv di = this;
    ...
    public String getTermName() {
        ...
        for (final EnumFacing direction : possibleDirections) {
            ...
            if (directedTile instanceof IInterfaceHost) {
                try {
                    if (((IInterfaceHost) directedTile).getInterfaceDualityAdv().sameGrid(this.gridProxy.getGrid())) {
                        continue;
                    }
                } catch (final GridAccessException e) {
                    continue;
    ...
    private class InterfaceRequestContext implements Comparable<Integer> {
        ...
        public int compareTo(Integer o) {
            return Integer.compare(DualityInterfaceAdv.this.priority, o);
        }
    }
    ...
    private class InterfaceInventory extends MEMonitorIInventory {
        ...
        public InterfaceInventory(final DualityInterfaceAdv tileInterface) {
        ...
        public IAEItemStack extractItems(final IAEItemStack request, final Actionable type, final IActionSource src) {
            final Optional<InterfaceRequestContext> context = src.context(InterfaceRequestContext.class);
            final boolean hasLowerOrEqualPriority = context.map(c -> c.compareTo(DualityInterfaceAdv.this.priority) <= 0).orElse(false);
    ...
    private class Accessor implements IStorageMonitorableAccessor {
        ...
        public IStorageMonitorable getInventory(IActionSource src) {
            return DualityInterfaceAdv.this.getMonitorable(src, DualityInterfaceAdv.this);
        }
