...
public class DriveWatcherImproved<T extends IAEStack<T>> extends MEInventoryHandler<T> {
    ...
    private final TileDriveImproved drive;
    private final IActionSource source;

    public DriveWatcherImproved(final ICellInventoryHandler<T> i, final ItemStack is, final ICellHandler han, final TileDriveImproved drive) {
