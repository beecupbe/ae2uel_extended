...
public class GridNode implements IGridNode, IPathItem {
    ...
    //private static final int[] CHANNEL_COUNT = {0, AEConfig.instance().getNormalChannelCapacity(), AEConfig.instance().getDenseChannelCapacity(), 64, 128, 256};
    ...
    public void beginVisit(final IGridVisitor g) {
        ...
        if (g instanceof final IGridConnectionVisitor gcv) {
