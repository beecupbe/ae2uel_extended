...
import appeng.tile.crafting.TileMolecularAssemblerCreative;
...
public class BlockMolecularAssemblerCreative extends AEBaseTileBlock {

    public static final PropertyBool POWERED = PropertyBool.create("powered");

    public BlockMolecularAssemblerCreative() {
        super(Material.IRON);
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
        ...
        TileMolecularAssemblerCreative te = this.getTileEntity(worldIn, pos);
        if (te != null) {
    ...
    public boolean onBlockActivated(final World w, final BlockPos pos, final IBlockState state, final EntityPlayer p, final EnumHand hand, final EnumFacing side, final float hitX, final float hitY, final float hitZ) {
        final TileMolecularAssemblerCreative tg = this.getTileEntity(w, pos);
    ...
    public void onNeighborChange(IBlockAccess world, BlockPos pos, BlockPos neighbor) {
        final TileMolecularAssemblerCreative tg = this.getTileEntity(world, pos);
        if (tg != null) {
