...
public class PartAvaritiaPatternTerminal extends AbstractPartEncoder {
    ...
    @Reflected
    public PartAvaritiaPatternTerminal(final ItemStack is) {
        super(is);
        this.crafting = new AppEngInternalInventory(this, 9 * 9);
    ...
    public GuiBridge getGuiBridge() {
        return GuiBridge.GUI_AVARITIA_PATTERN_TERMINAL;
    }
