...
public abstract class PartX128Cable extends PartCable {
    @Reflected
    public PartX128Cable(final ItemStack is) {
        super(is);

        this.getProxy().setFlags(GridFlags.X128_CAPACITY, GridFlags.PREFERRED);
    }
