...
public abstract class PartX64Cable extends PartCable {
    @Reflected
    public PartX64Cable(final ItemStack is) {
        super(is);

        this.getProxy().setFlags(GridFlags.X64_CAPACITY, GridFlags.PREFERRED);
    }
