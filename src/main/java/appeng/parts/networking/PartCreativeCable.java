...
public abstract class PartCreativeCable extends PartCable {
    @Reflected
    public PartCreativeCable(final ItemStack is) {
        super(is);

        this.getProxy().setFlags(GridFlags.CREATIVE_CAPACITY, GridFlags.PREFERRED);
    }
