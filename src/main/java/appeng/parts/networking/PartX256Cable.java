...
public abstract class PartX256Cable extends PartCable {
    @Reflected
    public PartX256Cable(final ItemStack is) {
        super(is);

        this.getProxy().setFlags(GridFlags.X256_CAPACITY, GridFlags.PREFERRED);
    }
