...
public abstract class PartUpgradeableImp extends PartBasicState implements IAEAppEngInventory, IConfigManagerHost {
    private final IConfigManager manager;
    private final UpgradeInventory upgrades;

    public PartUpgradeableImp(final ItemStack is) {
        super(is);
