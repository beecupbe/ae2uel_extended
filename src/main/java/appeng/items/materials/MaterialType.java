...
public enum MaterialType {
    ...
    CELL1MB_PART(61, "material_cell1mb_part", EnumSet.of(AEFeature.STORAGE_CELLS)),
    CELL4MB_PART(62, "material_cell4mb_part", EnumSet.of(AEFeature.STORAGE_CELLS)),
    CELL16MB_PART(63, "material_cell16mb_part", EnumSet.of(AEFeature.STORAGE_CELLS)),
    CELL64MB_PART(64, "material_cell64mb_part", EnumSet.of(AEFeature.STORAGE_CELLS)),
    CELL256MB_PART(65, "material_cell256mb_part", EnumSet.of(AEFeature.STORAGE_CELLS)),
    CELL1GB_PART(66, "material_cell1gb_part", EnumSet.of(AEFeature.STORAGE_CELLS)),
    CELL2GB_PART(67, "material_cell2gb_part", EnumSet.of(AEFeature.STORAGE_CELLS)),
