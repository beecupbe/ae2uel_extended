...
public final class DisassembleRecipe extends net.minecraftforge.registries.IForgeRegistryEntry.Impl<IRecipe> implements IRecipe {
    ...
    public DisassembleRecipe() {
        ...
        this.cellMappings.put(items.cell1mb(), mats.cell1mbPart());
        this.cellMappings.put(items.cell4mb(), mats.cell4mbPart());
        this.cellMappings.put(items.cell16mb(), mats.cell16mbPart());
        this.cellMappings.put(items.cell64mb(), mats.cell64mbPart());
        this.cellMappings.put(items.cell256mb(), mats.cell256mbPart());
        ...
        this.nonCellMappings.put(blocks.craftingStorage1mb(), mats.cell1mbPart());
        this.nonCellMappings.put(blocks.craftingStorage4mb(), mats.cell4mbPart());
        this.nonCellMappings.put(blocks.craftingStorage16mb(), mats.cell16mbPart());
        this.nonCellMappings.put(blocks.craftingStorage64mb(), mats.cell64mbPart());
        this.nonCellMappings.put(blocks.craftingStorage256mb(), mats.cell256mbPart());
        this.nonCellMappings.put(blocks.craftingStorage1gb(), mats.cell1gbPart());
        this.nonCellMappings.put(blocks.craftingStorage15gb(), mats.cell2gbPart());
