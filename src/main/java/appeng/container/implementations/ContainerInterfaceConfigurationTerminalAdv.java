...
public final class ContainerInterfaceConfigurationTerminalAdv extends AEBaseContainer {
    ...
    public ContainerInterfaceConfigurationTerminalAdv(final InventoryPlayer ip, final PartInterfaceConfigurationTerminalAdv anchor) {
        super(ip, anchor);
    ...
    public static class ConfigTracker {
        ...
        public ConfigTracker(final DualityInterfaceAdv dual, final IItemHandler configSlots, final String unlocalizedName) {
