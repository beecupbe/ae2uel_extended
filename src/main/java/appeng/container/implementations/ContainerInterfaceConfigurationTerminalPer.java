...
import appeng.parts.misc.PartInterfacePer;
import appeng.parts.reporting.PartInterfaceConfigurationTerminalPer;
import appeng.tile.inventory.AppEngInternalInventory;
import appeng.tile.misc.TileInterfacePer;
...
public final class ContainerInterfaceConfigurationTerminalPer extends AEBaseContainer {
    ...
    public ContainerInterfaceConfigurationTerminalPer(final InventoryPlayer ip, final PartInterfaceConfigurationTerminalPer anchor) {
        super(ip, anchor);
    ...
    public void detectAndSendChanges() {
        ...
        if (host != null) {
            ...
            if (agn != null && agn.isActive()) {
                for (final IGridNode gn : this.grid.getMachines(TileInterfacePer.class)) {
                    if (gn.isActive()) {
                        final IInterfaceHost ih = (IInterfaceHost) gn.getMachine();
                        if (ih.getInterfaceDualityPer().getConfigManager().getSetting(Settings.INTERFACE_TERMINAL) == YesNo.NO) {
                            continue;
                        }
                        ...
                        if (t == null) {
                            ...
                            final DualityInterfacePer dual = ih.getInterfaceDualityPer();
                ...
                for (final IGridNode gn : this.grid.getMachines(PartInterfacePer.class)) {
                    if (gn.isActive()) {
                        final IInterfaceHost ih = (IInterfaceHost) gn.getMachine();
                        if (ih.getInterfaceDualityPer().getConfigManager().getSetting(Settings.INTERFACE_TERMINAL) == YesNo.NO) {
                            continue;
    ...
    public static class ConfigTracker {
        ...
        public ConfigTracker(final DualityInterfacePer dual, final IItemHandler configSlots, final String unlocalizedName) {
