...
public final class ContainerInterfaceConfigurationTerminalImp extends AEBaseContainer {
    ...
    public ContainerInterfaceConfigurationTerminalImp(final InventoryPlayer ip, final PartInterfaceConfigurationTerminalImp anchor) {
        super(ip, anchor);
    ...
    public void detectAndSendChanges() {
        ...
        if (host != null) {
            ...
            if (agn != null && agn.isActive()) {
                for (final IGridNode gn : this.grid.getMachines(TileInterfaceImp.class)) {
                    if (gn.isActive()) {
                        final IInterfaceHost ih = (IInterfaceHost) gn.getMachine();
                        if (ih.getInterfaceDualityImp().getConfigManager().getSetting(Settings.INTERFACE_TERMINAL) == YesNo.NO) {
                            continue;
                        }
                        ...
                        if (t == null) {
                            ...
                            final DualityInterfaceImp dual = ih.getInterfaceDualityImp();
                ...
                for (final IGridNode gn : this.grid.getMachines(PartInterfaceImp.class)) {
                    if (gn.isActive()) {
                        final IInterfaceHost ih = (IInterfaceHost) gn.getMachine();
                        if (ih.getInterfaceDualityImp().getConfigManager().getSetting(Settings.INTERFACE_TERMINAL) == YesNo.NO) {
                            continue;
    ...
    public static class ConfigTracker {
        ...
        public ConfigTracker(final DualityInterfaceImp dual, final IItemHandler configSlots, final String unlocalizedName) {
