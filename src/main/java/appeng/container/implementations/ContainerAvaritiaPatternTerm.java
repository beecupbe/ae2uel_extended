...
public class ContainerAvaritiaPatternTerm extends ContainerPatternEncoder {


    public ContainerAvaritiaPatternTerm(final InventoryPlayer ip, final ITerminalHost monitorable) {
        super(ip, monitorable, false);

        this.craftingSlots = new SlotFakeCraftingMatrix[81];
        this.outputSlots = new OptionalSlotFake[1];
