...
import appeng.parts.misc.PartInterfacePatt;
import appeng.parts.reporting.PartInterfaceTerminalPatt;
...
public final class ContainerInterfaceTerminalPatt extends AEBaseContainer {
    ...
    public ContainerInterfaceTerminalPatt(final InventoryPlayer ip, final PartInterfaceTerminalPatt anchor) {
        super(ip, anchor);
    ...
    public void detectAndSendChanges() {
        ...
        if (host != null) {
            ...
            if (agn != null && agn.isActive()) {
                for (final IGridNode gn : this.grid.getMachines(TileInterfacePatt.class)) {
                    if (gn.isActive()) {
                        final IInterfaceHost ih = (IInterfaceHost) gn.getMachine();
                        if (ih.getInterfaceDualityPatt().getConfigManager().getSetting(Settings.INTERFACE_TERMINAL) == YesNo.NO) {
                            continue;
                        }
                        ...
                        if (t == null) {
                            ...
                            final DualityInterfacePatt dual = ih.getInterfaceDualityPatt();
                ...
                for (final IGridNode gn : this.grid.getMachines(PartInterfacePatt.class)) {
                    if (gn.isActive()) {
                        final IInterfaceHost ih = (IInterfaceHost) gn.getMachine();
                        if (ih.getInterfaceDualityPatt().getConfigManager().getSetting(Settings.INTERFACE_TERMINAL) == YesNo.NO) {
                            continue;
            ...
            if (action == InventoryAction.PLACE_SINGLE) {
                ...
                if (!itemStack.isEmpty()) {
                    var handler = new WrapperFilteredItemHandler(
                            new WrapperRangeItemHandler(inv.server, 0, 72), new PatternSlotFilter());
    ...
    private static class InvTracker {
        ...
        public InvTracker(final DualityInterfacePatt dual, final IItemHandler patterns, final String unlocalizedName) {
