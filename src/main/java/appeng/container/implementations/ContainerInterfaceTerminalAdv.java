...
public final class ContainerInterfaceTerminalAdv extends AEBaseContainer {
    ...
    public ContainerInterfaceTerminalAdv(final InventoryPlayer ip, final PartInterfaceTerminalAdv anchor) {
        super(ip, anchor);
    ...
    public void detectAndSendChanges() {
        ...
        if (host != null) {
            ...
            if (agn != null && agn.isActive()) {
                for (final IGridNode gn : this.grid.getMachines(TileInterfaceAdv.class)) {
                    if (gn.isActive()) {
                        final IInterfaceHost ih = (IInterfaceHost) gn.getMachine();
                        if (ih.getInterfaceDualityAdv().getConfigManager().getSetting(Settings.INTERFACE_TERMINAL) == YesNo.NO) {
                            continue;
                        }
                        ...
                        if (t == null) {
                            ...
                            final DualityInterfaceAdv dual = ih.getInterfaceDualityAdv();
                ...
                for (final IGridNode gn : this.grid.getMachines(PartInterfaceAdv.class)) {
                    if (gn.isActive()) {
                        final IInterfaceHost ih = (IInterfaceHost) gn.getMachine();
                        if (ih.getInterfaceDualityAdv().getConfigManager().getSetting(Settings.INTERFACE_TERMINAL) == YesNo.NO) {
                            continue;
            ...
            if (action == InventoryAction.PLACE_SINGLE) {
                ...
                if (!itemStack.isEmpty()) {
                    var handler = new WrapperFilteredItemHandler(
                            new WrapperRangeItemHandler(inv.server, 0, 18), new PatternSlotFilter());
    ...
    private static class InvTracker {
        ...
        public InvTracker(final DualityInterfaceAdv dual, final IItemHandler patterns, final String unlocalizedName) {
