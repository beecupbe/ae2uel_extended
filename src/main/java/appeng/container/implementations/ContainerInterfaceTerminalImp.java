...
public final class ContainerInterfaceTerminalImp extends AEBaseContainer {
    ...
    public ContainerInterfaceTerminalImp(final InventoryPlayer ip, final PartInterfaceTerminalImp anchor) {
        super(ip, anchor);
            ...
            if (action == InventoryAction.PLACE_SINGLE) {
                ...
                if (!itemStack.isEmpty()) {
                    var handler = new WrapperFilteredItemHandler(
                            new WrapperRangeItemHandler(inv.server, 0, 36), new PatternSlotFilter());
    ...
    private static class InvTracker {
        ...
        public InvTracker(final DualityInterfaceImp dual, final IItemHandler patterns, final String unlocalizedName) {
